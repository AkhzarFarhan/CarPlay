...
public final class LogDao_Impl implements LogDao {
  ...
  public LogDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfLogEntry = new EntityInsertionAdapter<LogEntry>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `logs` (`id`,`timestamp`,`tag`,`message`,`detail`) VALUES (nullif(?, 0),?,?,?,?)";
      }
  ...
  @Override
  public Flow<List<LogEntry>> getAllFlow() {
    final String _sql = "SELECT * FROM logs ORDER BY timestamp DESC LIMIT 100";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"logs"}, new Callable<List<LogEntry>>() {
      @Override
      @NonNull
      public List<LogEntry> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new LogEntry(_tmpId,_tmpTimestamp,_tmpTag,_tmpMessage,_tmpDetail);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getAllSync(final Continuation<? super List<LogEntry>> $completion) {
  ...
  public Object deleteByIds(final List<Integer> ids, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        _stringBuilder.append("DELETE FROM logs WHERE id IN (");
